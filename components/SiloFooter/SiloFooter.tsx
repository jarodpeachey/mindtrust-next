      ...
      <footer className="footer">
        <div className="container">
          <div className="footer__main">
            <div className="row footer__navigation">
              <div className="col-lg-12 col-xl-10">
                <div className="row">
                  <div className="col-6 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-xs-6">
                    <div className="h4">{props.silo} Talent</div>
              ...
              <div className="col-xl-2 centered">
                <a href="tel:844646387878" className="footer__phone">
                  844-MINDTRUST
                </a>
                ...
                <div className="social">
                  <a href="https://www.facebook.com/mindtrusthq/" target="_blank" rel="noopener" className="social__button">
                    <img loading="lazy" width="21" height="21" src="/media/img/icons/icon--facebook.svg" alt="Facebook" className="social__button--icon" />
                  </a>
                  <a href="https://twitter.com/MindTrustHQ" target="_blank" rel="noopener" className="social__button">
                    <img loading="lazy" width="21" height="21" src="/media/img/icons/icon--twitter.svg" alt="Twitter" className="social__button--icon" />
                  </a>
                  <a href="https://www.linkedin.com/company/mindtrust" target="_blank" rel="noopener" className="social__button">
                    <img loading="lazy" width="21" height="21" src="/media/img/icons/icon--linkedin.svg" alt="Linkedin" className="social__button--icon" />
                  </a>
                </div>
              </div>
            </div>
