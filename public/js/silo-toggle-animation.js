;(function () {
  ...
  const doughnutTwo = document.querySelector(".doughnut-two")
  const numberOne = document.querySelector(".silo-toggle-animation__number-1")
  const numberTwo = document.querySelector(".silo-toggle-animation__number-2")
  ...
  function toggleAnimation(toggleButton, click = false) {
    if (firstTime) {
      ...
      let frame = 0
      const countTo = parseInt(numberOne.getAttribute("data-animate"), 10)
      ...
      const counter = setInterval(() => {
        ...
        if (parseInt(numberOne.innerHTML, 10) !== currentCount) {
          numberOne.innerHTML = currentCount
        }
        ...
        if (previousSlide !== 2) {
          ...
          data.forEach(function (o, i) {
            let circle = document.createElementNS("http://www.w3.org/2000/svg", "circle"),
              ...
              dashArray = 2 * Math.PI * radius,
              dashOffset = dashArray - (dashArray * o.fill) / 100,
              angle = (filledTwo * 360) / 100 + startAngle,
              currentDuration = (animationDuration * o.fill) / 100,
              delay = (animationDuration * filledTwo) / 100
            circle.setAttribute("r", radius)
            circle.setAttribute("cx", cx)
            circle.setAttribute("cy", cy)
            circle.setAttribute("fill", "transparent")
          ...
          let frame = 0
          const countTo = parseInt(numberTwo.getAttribute("data-animate"), 10)
          ...
          const counter = setInterval(() => {
            ...
            if (parseInt(numberTwo.innerHTML, 10) !== currentCount) {
              numberTwo.innerHTML = currentCount
            }
