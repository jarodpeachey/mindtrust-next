...
;(function () {
  ...
  const siloLabel = document.querySelector("label.silo")
  const skillInput = document.querySelector("input.skill")
  const skillLabel = document.querySelector("label.skill")
  ...
  function onSubmit(e) {
    if (
      ...
      // submit form
      fetch("https://api.hsforms.com/submissions/v3/integration/submit/441110/1b6e573e-fbdc-470e-9c47-94da9760ff6c", {
        method: "post",
        body: JSON.stringify({
