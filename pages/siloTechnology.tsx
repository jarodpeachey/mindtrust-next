...
const SiloTechnology = ({ data }) => {
  ...
  return (
    <>
      <Head title={"Technology Teams as a Service."} silopage="true" bodyClass="silo technology" />
      <header>
        <Navigation />

        <div className="hero">
          {/* <img loading="lazy" src="/media/img/backgrounds/technology.svg" alt="Technology icon" className="background--icon" /> */}
      ...
      <main>
          ...
          <div className="container">
            ...
            <div className="row scene flex-column-reverse flex-lg-row">
              <div className="col-lg-5">
                ...
                <div className="flex mt-animate__slide mt-animate">
                  <a href="/technology-teams/cloud-architects" className="no-hover" aria-disabled="true">
                    Cloud Strategy
                  </a>
                  <a href="/technology-teams/enterprise-software-engineers" className="no-hover" aria-disabled="true">
                    Enterprise Software
                  </a>
                  <a href="/technology-teams/data-architects" className="no-hover" aria-disabled="true">
                    Big Data and Analytics
                  </a>
                  <a href="/technology-teams/robotic-process-automation-engineers" className="no-hover" aria-disabled="true">
            ...
            <div className="row scene">
              ...
              <div className="col-lg-5 offset-lg-1">
                ...
                <div className="flex mt-animate__slide mt-animate">
                  <a href="/technology-teams/cloud-engineers" className="no-hover" aria-disabled="true">
                    Cloud Operations
                  </a>
                  <a href="/technology-teams/server-infrastructure-engineers" className="no-hover" aria-disabled="true">
                    Infrastructure Management
                  </a>
                  <a href="/technology-teams/devops-engineers" className="no-hover" aria-disabled="true">
                    Continuous Integration
                  </a>
                  <a href="/technology-teams/virtualization-containerization-engineers" className="no-hover" aria-disabled="true">
            ...
            <div className="row scene flex-column-reverse flex-lg-row">
              <div className="col-lg-5">
                ...
                <div className="flex mt-animate__slide mt-animate">
                  <a href="/technology-teams/blockchain-engineers" className="no-hover" aria-disabled="true">
                    Blockchain Solutions
                  </a>
                  <a href="/technology-teams/ai-engineers" className="no-hover" aria-disabled="true">
                    AI and Machine Learning
                  </a>
                  <a href="/technology-teams/augmented-reality-engineers" className="no-hover" aria-disabled="true">
                    AR and Spatial Computing
                  </a>
                  <a href="/technology-teams/iot-engineers" className="no-hover" aria-disabled="true">
                    Internet of Things (IoT)
                  </a>
                </div>
              </div>
              <div className="col-lg-6 offset-lg-1 mt-animate__fade mt-animate">
                <SceneBrowser captionID="scene-three" className="scene--three" {...scene3} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="experts cut--bottom-left">
          <div className="container">
            <h2 className="mt-animate__fade mt-animate section-heading display">Certified engineers for top technology stacks</h2>
            <div className="row stack-animate">
              <div className="col-6 col-md-4">
                <a href="/technology-teams/aws-experts" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-aws.svg" alt="AWS logo" />
                  <p>AWS Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/azure-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-azure.svg" alt="Azure logo" />
                  <p>Azure Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/google-cloud-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-google-cloud.svg" alt="Google Cloud Experts logo" />
                  <p>Google Cloud Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/ibm-bluemix-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-bluemix.svg" alt="IBM Bluemix Experts" />
                  <p>IBM Bluemix Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/digital-ocean-experts" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-digital-ocean.svg" alt="DigitalOcean logo" />
                  <p>DigitalOcean Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/terraform-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-terraform.svg" alt="Terraform Experts" />
                  <p>Terraform Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/heroku-experts" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-heroku.svg" alt="Heroku logo" />
                  <p>Heroku Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/ansible-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-ansible.svg" alt="Ansible logo" />
                  <p>Ansible Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/circle-ci-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-circleci.svg" alt="Circle CI logo" />
                  <p>Circle CI Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/oracle-cloud-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-oracle-cloud.svg" alt="Oracle Cloud Experts logo" />
                  <p>Oracle Cloud Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/kubernetes-engineers" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-kubernetes.svg" alt="Kubernetes logo" />
                  <p>Kubernetes Experts</p>
                </a>
              </div>
              <div className="col-6 col-md-4">
                <a href="/technology-teams/netlify-experts" className="card animate">
                  <img loading="lazy" src="/media/img/logos/logo-netlify.svg" alt="Netlify logo" />
                  <p>Netlify Experts</p>
                </a>
              </div>
            </div>
        ...
        <section className="team">
          <div className="container">
            <h2 className="mt-animate__fade mt-animate section-heading">Technology teams that mean business</h2>
            <p className="mt-animate__fade mt-animate section-description">
            ...
            <div className="background">
              ...
              <div className="row">
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/cloud-solution-architects" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-1.jpg?auto=format" alt="Cloud solution architects" />
                    <h4>Cloud Solution Architects</h4>
                    <div className="more">
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/devops-engineers" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-2.jpg?auto=format" alt="DevOps Engineers" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/computer-network-architects" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-3.jpg?auto=format" alt="Computer Network Architects" />
                    <h4>Computer Network Architects</h4>
                    <div className="more">
                      <div className="hidden">Learn more</div>
                      <img src="/media/img/icons/icon--arrow-right.svg" alt="Arrow right" />
                    </div>
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/machine-learning-engineers" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-4.jpg?auto=format" alt="Machine Learning Engineers" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/cyber-security-engineers" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-5.jpg?auto=format" alt="Cyber Security Experts" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/systems-administrators" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-6.jpg?auto=format" alt="Systems Administrators" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/data-architects" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-7.jpg?auto=format" alt="Data Architects" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/database-administrators" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-8.jpg?auto=format" alt="Database Administrators" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/ai-engineers" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-9.jpg?auto=format" alt="Artificial Intelligence Engineers" />
                    <h4>Artificial Intelligence Engineers</h4>
                    <div className="more">
                      <div className="hidden">Learn more</div>
                      <img src="/media/img/icons/icon--arrow-right.svg" alt="Arrow right" />
                    </div>
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/iot-engineers" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-10.jpg?auto=format" alt="IoT Engineers" />
                    <h4>IoT Engineers</h4>
                    <div className="more">
                      <div className="hidden">Learn more</div>
                      <img src="/media/img/icons/icon--arrow-right.svg" alt="Arrow right" />
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/ci-cd-engineers" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-11.jpg?auto=format" alt="CI/CD Engineers" />
                    <h4>CI/CD Engineers</h4>
                    <div className="more">
                      <div className="hidden">Learn more</div>
                      <img src="/media/img/icons/icon--arrow-right.svg" alt="Arrow right" />
                    </div>
                ...
                <div className="col-6 col-md-4 col-lg-2">
                  <a href="/technology-teams/it-support-specialists" className="card">
                    <img loading="lazy" src="https://assets.mindtrust.com/img/technology/pic-12.jpg?auto=format" alt="IT Support Specialists" />
                    <h4>IT Support Specialists</h4>
                    <div className="more">
                      <div className="hidden">Learn more</div>
                      <img src="/media/img/icons/icon--arrow-right.svg" alt="Arrow right" />
                    </div>
      ...
      {hasWallItems && (
        <aside className="skills" aria-labelledby="possibilities">
          <div className="container">
            ...
            <p className="mt-animate__fade mt-animate section-description">
              With one flexible subscription for every technology need you can cross hiring producers off your list for good. This is more than a few helping
              hands—it’s a mindtrust of elite producers who can fill skill gaps as they emerge and adapt to fit your needs over time. Your MindTrust technology
